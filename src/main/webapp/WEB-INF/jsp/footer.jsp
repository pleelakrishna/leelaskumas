...
<script type='text/javascript' src='${pageContext.request.contextPath }/assets/js/dataTables.bootstrap.js'></script> 
<script type='text/javascript' src='${pageContext.request.contextPath }/assets/js/demo-datatables.js'></script> 
