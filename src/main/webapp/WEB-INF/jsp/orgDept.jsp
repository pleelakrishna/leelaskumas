					...
					<input type="checkbox" class="form-check-input" onclick="inactiveData();" id="inActive"> <label class="form-check-label">Show Inactive List</label>
						<div class="table-responsive" id="tableId">
							<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered datatables" id="example">
								<thead><tr><th>Org-Dept ID</th><th>Organization</th><th>Department</th><th>Parent Department</th><th></th></tr></thead>
								<tbody></tbody>
							</table>
						</div>
					</div>
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<div class="row">
                    		...
                    		<div class="col-md-6">
                    			<div class="form-group">
									<label for="focusedinput" class="col-md-6 control-label">Department <span class="impColor">*</span></label>
									<div class="col-md-5">
                    		...
                    		<div class="col-md-6">
                    			<div class="form-group">
									<label for="focusedinput" class="col-md-6 control-label">Parent Department <span class="impColor">*</span></label>
									<div class="col-md-5">
...
function displayTable(listOrders) {
	...
	$.each(listOrders,function(i, orderObj) {
		...
		var tblRow = "<tr>"
			+ "<td title='"+orderObj.org+"'>"+ orderObj.org + "</td>"
			+ "<td title='"+orderObj.dept+"'>"+ orderObj.dept + "</td>"
