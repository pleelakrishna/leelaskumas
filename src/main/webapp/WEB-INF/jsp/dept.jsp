						...
						<div class="row">
                    		<div class="col-md-4">
                    			<div class="form-group">
									...
									<div class="col-md-5">
										<form:input path="name" class="form-control validate nospecialCharacter" placeholder="Enter Name"/>	
...
function displayTable(listOrders) {
	...
	var tableHead = '<table id="example" class="table table-striped table-bordered datatables">'
			+ '<thead><tr><th>Name</th><th>Department Head</th><th>Description</th><th style="text-align: center;">Options</th></tr></thead><tbody></tbody></table>';
...
function inactiveData() {
	...
	if($('#inActive').is(":checked") == true){
		...
		$.fn.makeMultipartRequest('POST', 'inActivedepartments', false,
