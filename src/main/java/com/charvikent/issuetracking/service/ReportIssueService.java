...
*/
			...
			Category objCatergory=categoryDao.getCategoryNameById(Integer.parseInt(reportIssue.getCategory()));
			Severity objSeverity=severityDao.getSeverityNameById(Integer.parseInt(reportIssue.getSeverity()));

			VelocityContext velocityContext = new VelocityContext();
			velocityContext.put("assignedName",user.getUsername());
			velocityContext.put("issueId",reportIssue.getId());

			velocityContext.put("severity",objSeverity.getSeverity());
			velocityContext.put("category",objCatergory.getCategory());
