...
@font-face {
  ...
  src: url('./fonts/glyphicons-halflings-regular.eot?#iefix') format('embedded-opentype'), url('../assets/fonts/glyphicons-halflings-regular.woff2') format('woff2'), url('../assets/fonts/glyphicons-halflings-regular.woff') format('woff'), url('./assets/fonts/glyphicons-halflings-regular.ttf') format('truetype'), url('./fonts/glyphicons-halflings-regular.svg#glyphicons_halflingsregular') format('svg');
}
tfoot input {
        width: 100%;
        padding: 3px;
...
<script type='text/javascript' src='${baseurl }/assets/js/bootstrap-datetimepicker.js'></script>
<link rel="stylesheet" href="${baseurl }/assets/css/bootstrap-datetimepicker2.css">
